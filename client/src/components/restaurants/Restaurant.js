        ...
        <div className='container card mt-5 py-2'>
            {restaurants.length > 0 && (
                <>
                    ...
                    <img
                        src={`https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&maxheight=400&photoreference=${restaurants[0].photos[0].photo_reference}&key=${process.env.REACT_APP_API_KEY}`}
